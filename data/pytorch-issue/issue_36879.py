...
for epoch in range(25):
    ...
    for i,data in enumerate(dataloader, 0):
        ...
        if i % 100 == 0:
            vutils.save_image(real, '%s/real_samples.png' % "./Real_images", normalize=True)
            fake = netG(noise)
            vutils.save_image(fake.data, '%s/fake_samples_epoch_%03d.png' % ("./Gen_image", epoch), normalize=True)