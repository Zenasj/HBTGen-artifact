...
# the following are copied from https://github.com/openai/triton/blob/main/python/triton/ops/matmul.py
...
# benchmark starts
# baseline
test_tensor_a = torch.randn(1, 6144, dtype=torch.bfloat16, device='cuda')
test_tensor_b = torch.randn(6144, 4096, dtype=torch.bfloat16, device='cuda')
# warmup
for _ in range(10):
...
triton_meta={'signature': {0: '*bf16', 1: '*bf16', 2: '*bf16', 3: 'i32', 4: 'i32', 5: 'i32', 6: 'i32', 7: 'i32', 8: 'i32', 9: 'i32', 10: 'i32', 11: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {'acc_dtype': None, 'allow_tf32': True, 'fp8_fast_accum': True, 'BLOCK_M': 128, 'BLOCK_N': 128, 'BLOCK_K': 32, 'GROUP_M': 8, 'SPLIT_K': 1, 'EVEN_K': True, 'AB_DTYPE': None, 'M': 1, 'stride_ak': 1, 'stride_bn': 1, 'stride_cn': 1}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 4, 5, 6, 8, 10), equal_to_1=(3, 7, 9, 11), divisible_by_8=(4, 5, 6, 8, 10))]},