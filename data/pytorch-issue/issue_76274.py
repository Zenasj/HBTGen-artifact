...
class PrRoIPool2DFunction(ag.Function):
    ...
    @staticmethod
    def symbolic(g, features, rois, pooled_height, pooled_width, spatial_scale):
        return g.op("::PrRoIPool2DFunction", features, rois, pooled_height, pooled_width, spatial_scale)
