...
conv1d = torch.nn.Conv1d(2, 4, 6)
torch.jit.script(conv1d)  # This works

normed = torch.nn.utils.weight_norm(conv1d, name='weight', dim=2)
torch.jit.script(normed)  # this does not work
