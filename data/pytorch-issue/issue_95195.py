...
args = [((1024,), (1,), torch.bfloat16, 'cpu', False)]
...
class Repro(torch.nn.Module):
    ...
    def forward(self, op_inputs_dict_input_ : torch.Tensor):
        min_1 = torch.min(input = op_inputs_dict_input_);  op_inputs_dict_input_ = None
        return (min_1,)
