...
with torch.cuda.stream(copy_stream):
    ...
    # Uncomment this line to fix the corruption.
    # to_copy.record_stream(copy_stream)

    # Free "to_copy". Then without record_stream(), "to_calc * 100" will reuse
    # blocks in "to_copy".
    del to_copy
...
# It should print 100. But it might be about 5000.
