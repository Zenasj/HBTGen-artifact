...
from whisper_trt import __version__
from whisper_trt.cache import make_cache_dir, get_cache_dir
...
if __name__ == '__main__':
    class WhisperLarge(WhisperTRTBuilder):
        model = "large-v2"

    trt_builder = WhisperLarge()
    trt_builder.build(output_path="./whisper_large.trt", verbose=True)