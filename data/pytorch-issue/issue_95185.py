...
args = [((128, 256), (256, 1), torch.bfloat16, 'cpu', True)]
...
class Repro(torch.nn.Module):
    ...
    def forward(self, op_inputs_dict_input_ : torch.Tensor):
        amax = torch.amax(input = op_inputs_dict_input_, dim = [-1], keepdim = False);  op_inputs_dict_input_ = None
        return (amax,)
