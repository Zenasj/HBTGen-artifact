...
def main(onnx_path,image_path):
    ...
    input = cv2.resize(input, (512, 640)).transpose(2, 1, 0)
...
if __name__=='__main__':
    ...
    image_path = '/home/disk2/ray/workspace/Fly_Pluche/sod/HybridNets-main-20220728/HybridNets-main/images/full.jpg'
