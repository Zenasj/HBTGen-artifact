...
model_1 = Model1()
output_names_1 = ['v9_0', 'v0_0']

data_0 = np.random.normal(5, 1, size=(21, 1, 1, 10, 34)).astype(np.float32)
input_data = [data_0,]
...
try:
    for tensor_name_0, tensor_name_1 in output_name_dict.items():
        testing.assert_allclose(output_0[tensor_name_0], output_1[tensor_name_1], err_msg=f'at {tensor_name_0}, {tensor_name_1}')
