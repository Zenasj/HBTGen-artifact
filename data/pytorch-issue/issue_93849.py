...
def fn(input):
    v = torch.nn.functional.interpolate(input, [11], mode="nearest") 
      # works fine if `mode` is set to other values such as "linear"
...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, getitem):
        upsample_nearest1d = torch.ops.aten.upsample_nearest1d.default(arg0_1, [11]);  arg0_1 = None
        kthvalue = torch.ops.aten.kthvalue.default(upsample_nearest1d, 2);  upsample_nearest1d = None
        return [getitem]
        
args = [((5, 5, 5), (25, 5, 1), torch.float32, 'cpu'), ((5, 5), (5, 1), torch.float32, 'cpu')]
